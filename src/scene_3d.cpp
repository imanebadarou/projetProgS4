...
void Scene3D::initMesh(MeshBuffers &mesh, const std::vector<float> &vertices,
...
void Scene3D::destroyMesh(MeshBuffers &mesh) {
  if (mesh.ebo)
...
void Scene3D::drawMesh(const MeshBuffers &mesh) const {
  glBindVertexArray(mesh.vao);
